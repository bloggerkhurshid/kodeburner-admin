        ...
        {toasts.map((t) => (
          <div
            ...
            className={`pointer-events-auto p-4 rounded-xl shadow-lg border text-sm font-medium flex items-center justify-between transition-all duration-300 transform translate-y-0 ${
              t.type === 'success' ? 'bg-emerald-900/90 text-emerald-100 border-emerald-700/50 backdrop-blur-md' :
              t.type === 'error' ? 'bg-rose-900/90 text-rose-100 border-rose-700/50 backdrop-blur-md' :
